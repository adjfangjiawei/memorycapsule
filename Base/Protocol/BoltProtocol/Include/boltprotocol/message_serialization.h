...
namespace boltprotocol {
    ...
    // Note: serialize_run_message and serialize_begin_message signatures don't change,
    // but their implementations will adapt to new param struct members.
    ...
    BoltError serialize_run_message(const RunMessageParams& params, PackStreamWriter& writer, const versions::Version& target_bolt_version);  // Added target_bolt_version
    ...
    BoltError serialize_begin_message(const BeginMessageParams& params, PackStreamWriter& writer, const versions::Version& target_bolt_version);  // Added target_bolt_version
    ...
    BoltError deserialize_run_message_request(PackStreamReader& reader, RunMessageParams& out_params, const versions::Version& server_negotiated_version);  // Added server_negotiated_version
    ...
    BoltError deserialize_begin_message_request(PackStreamReader& reader, BeginMessageParams& out_params, const versions::Version& server_negotiated_version);  // <--- ADDED
